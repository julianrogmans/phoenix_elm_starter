...
var _user$project$Types$GraphqlResponse = function (a) {
	return {ctor: 'GraphqlResponse', _0: a};
};
...
var _user$project$Graphql_Utils$createRequest = F2(
...
var _user$project$Graphql_Schema$query = F2(
	function (query, decoder) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Types$GraphqlResponse,
			A2(
				_user$project$Graphql_Utils$createRequest,
				_user$project$Graphql_Utils$createQuery(query),
				_user$project$Graphql_Utils$createDecoder(decoder)));
	});

var _user$project$Graphql_Requests$routeRequest = function (route) {
	var _p0 = route;
	if ((_p0.ctor === 'Just') && (_p0._0.ctor === 'Home')) {
		return A2(_user$project$Graphql_Schema$query, _user$project$Graphql_Queries$userQuery, _user$project$Graphql_Decoders$userDecoder);
	} else {
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'GraphqlResponse':
				var _p1 = _krisajenkins$remotedata$RemoteData$fromResult(_p0._0);
				switch (_p1.ctor) {
					case 'NotAsked':
					...
					default:
						var log = A2(_elm_lang$core$Debug$log, 'Data: ', _p1._0);
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'Login':
				var _p2 = A2(_user$project$Login_View$update, _p0._0, model.login);
...
if (typeof _user$project$App$main !== 'undefined') {
    _user$project$App$main(Elm['App'], 'App', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Types.Msg":{"args":["a"],"tags":{"NavigateTo":["String"],"GraphqlResponse":["Result.Result Http.Error a"],"UrlChange":["Navigation.Location"],"Login":["Login.View.Msg"],"NoOp":[]}},"Login.View.Msg":{"args":[],"tags":{"EmailInputChange":["String"],"PasswordInputChange":["String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Types.Msg { email : String, id : Int, name : String }"},"versions":{"elm":"0.18.0"}});
}
